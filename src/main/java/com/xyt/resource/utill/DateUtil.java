...
public class DateUtil {
   ...
   * @return
   */
  public String formatDate(String datePattern, Date date) {
      String strEndDate;
      try {
          Calendar calEndDate = Calendar.getInstance();
          calEndDate.setTime(date);
          calEndDate.add(Calendar.HOUR_OF_DAY, 23);
          calEndDate.add(Calendar.MINUTE, 59);
          calEndDate.add(Calendar.SECOND, 59);

          strEndDate = DateUtil.dateToString(calEndDate.getTime(), datePattern);
      } catch (Exception e) {
          return null;
      }
      return strEndDate;
   ...
   * @return
   */
  public static Date addYearAndDay(Date date, int yearAmount, int dayAmount) {
	Date newDate = addYear(date, yearAmount);
	return addInteger(newDate, Calendar.DATE, dayAmount);
  }
  ...
  public enum DateStyle {
    ...
    MM_DD_EN("MM/dd"), YYYY_MM_EN("yyyy/MM"), YYYY_MM_DD_EN(
      "yyyy/MM/dd"), MM_DD_HH_MM_EN("MM/dd HH:mm"), MM_DD_HH_MM_SS_EN(
        "MM/dd HH:mm:ss"), YYYY_MM_DD_HH_MM_EN(
          "yyyy/MM/dd HH:mm"), YYYY_MM_DD_HH_MM_SS_EN("yyyy/MM/dd HH:mm:ss"),

    MM_DD_CN("MM月dd日"), YYYY_MM_CN("yyyy年MM月"), YYYY_MM_DD_CN(
      "yyyy年MM月dd日"), MM_DD_HH_MM_CN("MM月dd日 HH:mm"), MM_DD_HH_MM_SS_CN(
        "MM月dd日 HH:mm:ss"), YYYY_MM_DD_HH_MM_CN(
          "yyyy年MM月dd日 HH:mm"), YYYY_MM_DD_HH_MM_SS_CN(
            "yyyy年MM月dd日 HH:mm:ss"), YYYYMMDDHHMMSSCN(
              "yyyyMMddHHmmss"), YYYYMMDDHHMMssSSSCN(
                "yyyyMMddHHmmssSSS"), HH_MM("HH:mm"), HH_MM_SS("HH:mm:ss");
  ...
  public enum Week {
    MONDAY("星期一", "Monday", "Mon.", 1), TUESDAY("星期二", "Tuesday", "Tues.",
      2), WEDNESDAY("星期三", "Wednesday", "Wed.", 3), THURSDAY("星期四", "Thursday",
        "Thur.", 4), FRIDAY("星期五", "Friday", "Fri.", 5), SATURDAY("星期六", "Saturday",
  ...
  public static String[] getTargetTime() {
    ...
    targetarr[0] = String.valueOf(now.get(Calendar.YEAR));
    targetarr[1] = String.valueOf((now.get(Calendar.MONTH) + 1));
    targetarr[2] = String.valueOf(now.get(Calendar.DAY_OF_MONTH));
    return targetarr;
  }
  ...
  public static String formatDate(String date) {
      ...
      if (!StringUtils.isEmpty(date)) {
          rtn = date.substring(0, 4) + "年" + Integer.parseInt(date.substring(5, 7)) + "月" + Integer.parseInt(date.substring(8, 10)) + "日";
      }
      return rtn;
  }
